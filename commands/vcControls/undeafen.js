...
module.exports = {
    ...
    execute: async (interaction, client) => {
        ...
        if (!hasDeafenMembersPermission(commandUserId, guild, ownerId)) {
            return messages.error(interaction, "You need `Deafen Members` permission, Administrator, or be the bot owner to use this command.");
        }
        ...
        try {
            ...
            console.error(`Undeafen error: ${error.message}`);
            await messages.error(interaction, `Failed to undeafen: ${error.message}`);
        }
    },
    prefixExecute: async (message, args, client) => {
        ...
        try {
            ...
            console.error(`Undeafen error: ${error.message}`);
            await messages.error(message, `Failed to undeafen: ${error.message}`);
        }
    }
};
